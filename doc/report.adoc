...
// Include "Title" (as section), author and revision for embedded display
ifdef::embedded[]
[pass,subs=normal]
== {doctitle}
{authors} -- Version {revnumber}, {revdate} | {revremark}
...
This visitor is defined in the file https://github.com/Rvb0rob0t/miniPascal_compiler/blob/master/include/llvm.hpp[llvm.hpp].
