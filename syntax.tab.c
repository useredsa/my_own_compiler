...
{
       0,    57,    57,    63,    64,    66,    73,    75,    77,    80,
      82,    83,    85,    86,    88,    89,    90,    92,    93,    95,
      96,    97,   100,   101,   103,   104,   105,   106,   107,   108,
     109,   110,   111,   114,   115,   118,   119,   122,   124,   125,
     128,   129,   131,   132,   135,   136,   138
};
#endif
...
static const char *const yytname[] =
{
  ...
  "\"program\"", "\"function\"", "\"const\"", "\"var\"", "\"intlit\"",
  "\"begin\"", "\"end\"", "\"if\"", "\"then\"", "\"else\"", "\"while\"",
  "\"do\"", "\"for\"", "\"to\"", "\"write\"", "\"read\"", "\"id\"",
  "\";\"", "\":\"", "\".\"", "\",\"", "\"+\"", "\"-\"", "\"*\"", "\"/\"",
  "\"(\"", "\")\"", "\":=\"", "\"identifiers\"", "\"type\"", "$accept",
  "program", "functions", "function", "declarations", "compound_statement",
  "optional_statements", "statements", "statement", "expressions",
  "expression", "arguments", "identifiers", "type", "constants",
  "print_list", "print_item", "read_list", "read_item", YY_NULLPTR
};
#endif
...
{
      -2,   -14,     8,   -13,   -48,    -6,     4,   -48,    18,     9,
      16,    27,    14,   -48,    34,    38,    62,    15,    43,    26,
      29,   -48,    -7,     2,     2,    39,    32,    50,    56,   -48,
      60,    51,   -48,   -48,    66,     2,   -48,    72,    98,    81,
     -48,    73,     2,     2,    20,    37,    74,     1,    83,     2,
     -48,    62,    82,    69,    75,   -48,    86,   -48,     2,    69,
      63,    62,     2,     2,     2,     2,    62,     2,   -48,    69,
     -19,   -48,   -48,   -16,   -48,    69,   -48,    76,     2,   -48,
      84,    69,    80,   -48,    99,    69,    69,    69,    69,   -48,
      58,     1,   -48,    83,   -48,    85,    69,     2,   -48,    62,
       2,   -48,   -48,    89,    69,   -48,    41,    87,    62,   -48,
     -48,    27,   -48
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       0,    36,     0,     0,     0,     0,     0,     0,     0,    21,
       0,    10,    13,     2,     0,     0,     7,     0,     0,     0,
      31,    30,     0,     0,     0,     0,     0,     0,     0,     0,
       9,     0,     0,    39,     0,    37,     0,    35,    34,    28,
       0,     0,     0,     0,     0,     0,     0,     0,    43,    42,
       0,    41,    46,     0,    45,    14,    12,     0,     0,     6,
      33,    23,     0,    29,    15,    24,    25,    26,    27,    17,
       0,     0,    19,     0,    20,     0,    38,     0,    32,     0,
       0,    40,    44,     0,    22,    16,     0,     0,     0,     8,
      18,     0,     5
};
...
{
     -48,   -48,   -48,   -48,     5,   -11,   -48,   -48,   -47,   -48,
     -22,   -48,   -48,   -48,   -48,   -48,    24,   -48,    25
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     8,    10,    11,    29,    30,    31,    32,    80,
      69,    82,    22,    56,    20,    70,    71,    73,    74
};
...
{
      17,    44,    45,     1,    76,    68,    91,     3,     4,    93,
      40,    40,    92,    53,    84,    94,    38,     5,    39,    89,
      59,    60,    41,    41,     9,     6,     7,    75,    42,    42,
      12,    43,    43,    61,    14,    15,    81,    16,    13,    33,
      85,    86,    87,    88,    18,    90,    62,    63,    64,    65,
      34,    36,   105,    66,    37,    19,    96,   108,    35,    21,
      46,   110,    47,    62,    63,    64,    65,    62,    63,    64,
      65,    50,    16,    51,    23,   104,   100,    24,   106,    25,
      48,    26,    27,    28,    62,    63,    64,    65,    49,    62,
      63,    64,    65,    54,    83,    62,    63,    64,    65,    52,
     112,    55,    57,    58,    72,    77,    67,    78,    79,    97,
      95,    98,   107,    99,   111,   101,   103,     0,   102,     0,
       0,   109
};

static const yytype_int8 yycheck[] =
{
      11,    23,    24,     5,    51,     4,    25,    21,     0,    25,
       9,     9,    31,    35,    61,    31,    23,    30,    25,    66,
      42,    43,    21,    21,     6,    31,    22,    49,    27,    27,
      21,    30,    30,    13,     7,     8,    58,    10,    22,    24,
      62,    63,    64,    65,    30,    67,    26,    27,    28,    29,
       7,    22,    99,    16,    25,    21,    78,    16,    32,    21,
      21,   108,    30,    26,    27,    28,    29,    26,    27,    28,
      29,    11,    10,    22,    12,    97,    18,    15,   100,    17,
      30,    19,    20,    21,    26,    27,    28,    29,    32,    26,
      27,    28,    29,    21,    31,    26,    27,    28,    29,    33,
     111,     3,    21,    30,    21,    23,    32,    32,    22,    25,
      34,    31,    23,    14,   109,    91,    31,    -1,    93,    -1,
      -1,    34
};
...
{
       0,     5,    36,    21,     0,    30,    31,    22,    37,     6,
      38,    39,    21,    22,     7,     8,    10,    40,    30,    21,
      49,    21,    47,    12,    15,    17,    19,    20,    21,    40,
      41,    42,    43,    24,     7,    32,    22,    25,    23,    25,
       9,    21,    27,    30,    45,    45,    21,    30,    30,    32,
      11,    22,    33,    45,    21,     3,    48,    21,    30,    45,
      45,    13,    26,    27,    28,    29,    16,    32,     4,    45,
      50,    51,    21,    52,    53,    45,    43,    23,    32,    22,
      44,    45,    46,    31,    43,    45,    45,    45,    45,    43,
      45,    25,    31,    25,    31,    34,    45,    25,    31,    14,
      18,    51,    53,    31,    45,    43,    45,    23,    16,    34,
      43,    39,    40
};
